        ...
        private IdentityGenerator()
        {
            ...
            else
            {
                ...
                if (type.Equals(this.GetType()))
                    throw new ApstarsException("Type {0} cannot be used as identity generator, it is maintained by the Apstars framework internally.", this.GetType().AssemblyQualifiedName);
