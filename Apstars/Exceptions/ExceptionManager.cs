...
namespace Apstars.Exceptions
{
    ...
    public sealed class ExceptionManager
    {
        ...
        private ExceptionManager()
        {
            try
            {
                ApstarsConfigSection config = AppRuntime.Instance.CurrentApplication.ConfigSource.Config;
        ...
        /// <summary>
        /// Gets all the exception types registered in the Apstars configuration section.
        /// </summary>
