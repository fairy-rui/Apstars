...
<configurationSectionModel xmlns:dm0="http://schemas.microsoft.com/VisualStudio/2008/DslTools/Core" dslVersion="1.0.0.0" Id="37648ba3-512d-4438-b0c0-a03ba1b2c700" namespace="Apstars.Config" xmlSchemaNamespace="http://apstars.org/Schemas/Configuration" xmlns="http://schemas.microsoft.com/dsltools/ConfigurationSectionDesigner">
  <typeDefinitions>
    ...
    <enumeratedType name="HandlerKind" namespace="Apstars.Config">
      <literals>
        <enumerationLiteral name="Command" />
        <enumerationLiteral name="Event" />
      </literals>
    </enumeratedType>
    <enumeratedType name="HandlerSourceType" namespace="Apstars.Config">
      <literals>
        <enumerationLiteral name="Type" />
        <enumerationLiteral name="Assembly" />
      </literals>
    </enumeratedType>
    <enumeratedType name="ExceptionHandlingBehavior" namespace="Apstars.Config">
      <literals>
  ...
  <configurationElements>
    <configurationSection name="ApstarsConfigSection" documentation="Represents the configuration section for Apstars framework." codeGenOptions="XmlnsProperty" xmlSectionName="apstars">
      <elementProperties>
        <elementProperty name="Application" isRequired="true" isKey="false" isDefaultCollection="false" xmlName="application" isReadOnly="false" documentation="The configuration for the Apstars application.">
          <type>
        ...
        <elementProperty name="Exceptions" isRequired="false" isKey="false" isDefaultCollection="false" xmlName="exceptions" isReadOnly="false" documentation="The configuration for exception handling logic within Apstars framework.">
          <type>
